...
export default function HomeContent() {
    const { data, isPending } = useQuery(homeOptions())
    ...
    const sectionBySlug = (slug) => {
        ...
        return found?.length ? found : latest
    }
                        ...
                        {hero && (
                            <div className="col-span-2">
                                <div className="relative h-100 rounded-sm overflow-hidden shadow-[0_2px_1px_0_rgba(0,0,0,0.1)] hover:shadow-[0_4px_6px_rgba(0,0,0,0.15)] transition">
                                    <LazyImage src={img(hero)} alt={hero.title} className="absolute inset-0" priority sizes="(max-width: 768px) 100vw, 40vw" />
