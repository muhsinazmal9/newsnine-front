...
export default function ArticleContent() {
    ...
    const [{ data: article, isPending: articlePending }, { data: related, isPending: relatedPending }] = useQueries({
        queries: [articleOptions(id), relatedOptions(id)],
    })

    if (articlePending || relatedPending) return <PageLoader />
